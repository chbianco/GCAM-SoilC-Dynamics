...
# Results
Both the rates and k values differed based on the source of the data. 
...
```{r, echo=FALSE, fig.cap="Histograms showing overlapping GCAM and experimental data for computed k values during land use change. Here, the experimental data is taken from Post & Kwonfrom both Post & Kwon and Wei et al.", message=FALSE}
#Plot overlapping k histograms for the different k sources
ggplot() +
